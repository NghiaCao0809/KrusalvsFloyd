...
namespace DoanLTDT
{
    public partial class Krusal : Form
    {
        public Krusal()
        {
            InitializeComponent();
        ...
        List<NodeK> m_lstVertices;
        List<Link> m_lstEdgesInitial, m_lstEdgesFinal;

        NodeK m_vFirstVertex, m_vSecondVertex;
        ...
        private void panel1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                m_lstVertices.Add(new NodeK(m_lstVertices.Count, pClicked));
                panel1.Invalidate();
            }
        }
        ...
        private void DrawVertices(Graphics g)
        {
            ...
            foreach (NodeK v in m_lstVertices)
            {
        ...
        private NodeK GetSelectedVertex(Point pClicked)
        {
            NodeK vReturn = null;
            double dDistance;
            foreach (NodeK v in m_lstVertices)
